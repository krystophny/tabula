...
import {
  handleMeetingSegmentDocumentFollow,
  startMeetingDocumentTracking,
  stopMeetingDocumentTracking,
...
export function initRuntimeUi() {
  ...
  configureLiveSession({
    ...
    onMeetingSegment: (message) => {
      handleMeetingSegmentDocumentFollow(message);
    },
    onMeetingStarted: () => {
      startMeetingDocumentTracking();
    },
