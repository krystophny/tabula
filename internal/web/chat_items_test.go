...
func TestParseInlineItemIntent(t *testing.T) {
	...
	cases := []struct {
		...
		{text: "idea: better swipe triage", wantAction: canonicalActionAnnotateCapture},
		{text: "new idea: add a review inbox", wantAction: canonicalActionAnnotateCapture},
		{text: "Idee: bessere Rückfragen für den Review-Modus", wantAction: canonicalActionAnnotateCapture},
		{text: "expand this idea", wantAction: canonicalActionCompose, wantKind: "expand"},
		{text: "Baue diese Idee aus", wantAction: canonicalActionCompose, wantKind: "expand"},
		{text: "add pros and cons", wantAction: canonicalActionCompose, wantKind: "pros_cons"},
		{text: "Ergänze Vor- und Nachteile", wantAction: canonicalActionCompose, wantKind: "pros_cons"},
		{text: "compare alternatives", wantAction: canonicalActionCompose, wantKind: "alternatives"},
		{text: "Vergleiche Alternativen", wantAction: canonicalActionCompose, wantKind: "alternatives"},
		{text: "outline an implementation", wantAction: canonicalActionCompose, wantKind: "implementation"},
		{text: "Skizziere eine Umsetzung", wantAction: canonicalActionCompose, wantKind: "implementation"},
		...
		{text: "split this into three items", wantAction: canonicalActionTrackItem, wantCount: 3},
		{text: "Teile das in drei Aufgaben", wantAction: canonicalActionTrackItem, wantCount: 3},
	}
