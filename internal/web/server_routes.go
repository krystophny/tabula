...
func (a *App) Router() http.Handler {
	...
	r.Get("/api/runtime/workspaces", a.handleProjectsList)
	r.Get("/api/runtime/workspaces/activity", a.handleProjectsActivity)
	r.Post("/api/runtime/workspaces", a.handleProjectCreate)
	r.Post("/api/runtime/workspaces/{workspace_id}/activate", a.handleProjectActivate)
	r.Post("/api/runtime/workspaces/{workspace_id}/persist", a.handleTemporaryProjectPersist)
	r.Post("/api/runtime/workspaces/{workspace_id}/discard", a.handleTemporaryProjectDiscard)
	r.Post("/api/runtime/workspaces/{workspace_id}/chat-model", a.handleProjectChatModelUpdate)
	r.Get("/api/runtime/workspaces/{workspace_id}/snapshot", a.handleProjectContext)
	r.Get("/api/workspaces/{workspace_id}/files", a.handleWorkspaceFilesList)
	r.Get("/api/runtime/workspaces/{workspace_id}/welcome", a.handleProjectWelcome)
